...
const Recommendation: React.FC = () => {
  ...
  return (
    <section id="recommendation" className="pf-section pf-recommendation">
      <div className="pf-container">
        ...
        <div ref={cardRef} className="pf-recommend pf-reveal">
          ...
          <blockquote
            className={`pf-recommend__quote ${expanded ? "expanded" : "collapsed"}`}
          ...
          <div className="pf-recommend__foot">
            <div className="pf-recommend__person">
              <div className="pf-recommend__avatar" aria-hidden="true">
                {/* {r.initials} */}
                <img src={r.imageUrl} alt="Jaikant Singh" />
              </div>
